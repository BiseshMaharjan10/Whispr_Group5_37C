...
public class Trial extends javax.swing.JFrame {
    ...
    public Trial() {
     ...
     String message = Backend.getMessage(); // Example: calling your backend method
     example.setText(message);           // Setting backend text into the JLabel
    }
